...
* It was noted that Chapter Committee Charter item will held for discussion only if committee representatives joined (none did)
...
- Belgium  – legacy EU entity: Belgian accountants notified OWASP to close the entity; Andrew is attempting to schedule with them
- New OWASP EU entity: No registration update yet (ED monitoring Belgium Government website).
...
- Travel booking trial: Using Navan (no fees) for Staff/Board to improve cost visibility and policy control. Directors asked to provide Washington DC 2025 conference arrival details to Events.
...
- OWASP Support site: Building support.owasp.org in Confluence with 'how-to' guides (expenses, chapters, etc.).
- Platform audit / consolidation: Moving to monday.com work management; cancelling duplicative tools (Calendly retained; Wufoo, Submittable, Zapier flows, etc. being retired or migrated). Estimated annual savings: ~$9.4k; bigger future savings possible if Glue Up can replace Meetup for chapters.
...
- [Finance Cash Flow Forecast](/www-board/attachments/202506-finance-cash.pdf)
- [Finance Uncategorized Items](/www-board/attachments/202506-finance-ar.pdf)
- June 2025 results: Income: $28k; Expenses: $329k; Net loss ~$120k (primarily Israel AppSec Conference costs beginning to hit).
- YTD through June: Income: $2.767M (+$450k vs. budget). Sponsorship ahead; training under-reported due to interim coding approach during Glue Up reconciliation. Staff provided detail; corrections to appear in July reports.
- Expenses: $2.1M ($51k under budget), largely timing/underspend on web/software redesign.
